...
*			uint32_t rst_period		复位周期，取值1--2^31，单位1/32768秒，取值0表示关闭WDT复位功能，rst_period 需大于 int_peroid
* 输    出: 无
* 注意事项: 无
******************************************************************************************************************************************/
void WDT_Init(WDT_TypeDef * WDTx, uint32_t int_period, uint32_t rst_period)
{
	...
	WDTx->CR |= (1 << WDT_CR_LOCK_Pos);
	while(WDTx->CR & WDT_CR_LOCK_Msk) __NOP();
}
