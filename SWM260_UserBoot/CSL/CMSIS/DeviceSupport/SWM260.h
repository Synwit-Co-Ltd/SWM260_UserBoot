...
typedef struct {
    ...
    __IO uint32_t PORTA_PULLD;              //下拉使能
	...
	__IO uint32_t PORTA_OPEND;              //开漏使能
...
typedef struct {
	...
	__IO uint32_t TRIG;						//对应位置1后，则相应通道触发ADC功能被屏蔽
...
#define ADC_CTRL3_CLKDIV_Pos		24		//1 1分频   2 2分频 ...
...
#define FMC_ERASE_CHIP_Pos			16		//1 正片擦除
