...
{	
	...
	ADC_K = *((volatile uint32_t *) 0x40000098) >> 16;
	ADC_Offset = *((volatile uint32_t *) 0x40000098)&0xFFFF;
...
static uint32_t ADCCaliValue(uint32_t value)
{	//修正转换结果
	int32_t val = (value - ADC_Offset) * ADC_K / 1000;
