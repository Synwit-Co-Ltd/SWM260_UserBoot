#ifndef __SWM260_ADC_H__
#define	__SWM260_ADC_H__
...
typedef struct {
	...
	uint8_t trig_src;		//ADC触发方式：ADC_TRIGGER_SW、ADC_TRIGGER_PWM、ADC_TRIGGER_TIMR2、ADC_TRIGGER_TIMR3
...
#define ADC_REFP_INTERNAL		0
#define ADC_REFP_EXTERNAL		3
